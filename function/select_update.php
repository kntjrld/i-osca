...
<div class="display-record">
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="text" style="text-transform: uppercase;" name="update_firstname" id="update_firstname"
                class="form-control" placeholder="Enter first name" aria-label="First name"
                value="<?php echo $update_firstname ?>">
        </div>
        <div class="col">
            <label class="form-label required">Last Name</label>
            <input type="text" style="text-transform: uppercase;" name="update_lastname" id="update_lastname"
                class="form-control" placeholder="Enter last name" aria-label="Last name"
                value="<?php echo $update_lastname ?>">
        </div>
        <div class="col">
            <label class="form-label required">Middle Name</label>
            <input type="text" style="text-transform: uppercase;" name="update_middlename" id="update_middlename"
                class="form-control" placeholder="Enter middle name" aria-label="Middle name"
                value="<?php echo $update_midlle ?>">
        </div>
        <div class="col">
            <label class="form-label required">Extension Name</label>
            <input type="text" style="text-transform: uppercase;" name="update_extension" id="update_extension"
                class="form-control" placeholder="N/A if none" aria-label="Extension name"
                value="<?php echo $update_extention ?>">
        </div>
    </div>
    <!-- Contacts  -->
    <div class="row">
        ...
        <div class="col">
            <div class="mb-2">
                ...
                <input type="num" name="update_email" id="update_email" class="form-control"
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="mb-2">
                ...
                <input type="date" name="started" id="started" class="form-control" value="<?php echo $started ?>"
                    disabled>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <select class="form-select" id="update_barangay" name="update_barangay" style="width: auto;"
                ...
                <option value="Barangay 1" <?php if($update_barangay=="Barangay 1") echo 'selected="selected"'; ?>>
                    Barangay
                    1</option>
                <option value="Barangay 2" <?php if($update_barangay=="Barangay 2") echo 'selected="selected"'; ?>>
                    Barangay
                    2</option>
                <option value="Barangay 3" <?php if($update_barangay=="Barangay 3") echo 'selected="selected"'; ?>>
                    Barangay
                    3</option>
                <option value="Barangay 4" <?php if($update_barangay=="Barangay 4") echo 'selected="selected"'; ?>>
                    Barangay
                    4</option>
                <option value="Barangay 5" <?php if($update_barangay=="Barangay 5") echo 'selected="selected"'; ?>>
                    Barangay
                    5</option>
                <option value="Barangay 6" <?php if($update_barangay=="Barangay 6") echo 'selected="selected"'; ?>>
                    Barangay
                    6</option>
                <option value="Barangay 7" <?php if($update_barangay=="Barangay 7") echo 'selected="selected"'; ?>>
                    Barangay
                    7</option>
                <option value="Barangay 8" <?php if($update_barangay=="Barangay 8") echo 'selected="selected"'; ?>>
                    Barangay
                    8</option>
                <option value="Fatima" <?php if($update_barangay=="Fatima") echo 'selected="selected"'; ?>>Fatima
                </option>
                ...
                <option value="Tangkalan" <?php if($update_barangay=="Tangkalan") echo 'selected="selected"'; ?>>
                    Tangkalan
                </option>
        ...
        <div class="col">
            ...
            <input type="number" id="view_age" name="view_age" class="form-control" placeholder=" > 59"
                aria-label="Age" value="<?php echo $intAge ?>" disabled>
        </div>
        <div class="col">
    ...
    <div class="d-flex justify-content-between p-2">
        <div class="d-block" style="width:30%" ;>
            ...
            <input type="text" name="view_status" id="view_status" class="form-control"
                value="<?php echo $update_status ?>" disabled>
        </div>
        <div class="d-block">
        ...
        <div class="d-block">
            ...
            <label class="form-check-label" for="life_status">Deceased</label>
        </div>

        <div class="d-block" id="r_status">
    ...
    <div class="mb-3" id="div-remarks"
        ...
        <label for="remarks" class="form-label">Remarks <span style="font-size:12px;">*Leave a short remarks if inactive
                or
                deceased</span></label>
        <textarea class="form-control" name="remarks" id="remarks" maxlength="30"
            rows="1"><?php echo $remarks ?></textarea>
    </div>
</div>