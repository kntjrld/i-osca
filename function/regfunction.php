...
if($intAge < 60){
    ...
    // Table register
        $register = "INSERT INTO tbl_register(uid, fx_idnumber, fx_idpresented, fx_firstname, fx_lastname, fx_initial, fx_extension, fx_gender, fd_birthdate, fx_barangay, fx_contact, fx_email, fn_age, fd_application, fx_pwd)
        VALUES('$uid',UPPER('$id_number'),'$id_name', UPPER('$userfirstname'),UPPER('$userlastname'),UPPER('$userinitial'), UPPER('$userextension') ,'$gender','$birthday','$barangay','$countrycode$contact', '$email', '$intAge', '$appdate', '$pwd')";
